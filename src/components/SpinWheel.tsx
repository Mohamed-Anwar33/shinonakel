  ...
  return <div className="relative flex flex-col items-center">
      ...
      <div className="relative w-72 h-72 sm:w-80 sm:h-80">
        ...
        <div className="absolute inset-0 rounded-full bg-[#1e3a5f] p-2">
          ...
          <button onClick={spinWheel} disabled={isSpinning} className="w-full h-full rounded-full flex items-center justify-center cursor-pointer transition-transform hover:scale-105 active:scale-95 disabled:opacity-70" style={{
            backgroundColor: singleCategoryView.color
                ...
                <span className="drop-shadow-lg select-none text-center font-thin text-9xl px-0 py-[24px] pt-0 mb-0 mr-[4px] pl-[8px] pr-[6px] pb-[15px]" style={{
              lineHeight: 1,
              display: 'flex',
              alignItems: 'center',
        ...
        {!singleCategoryView && <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <button onClick={spinWheel} disabled={isSpinning} className="w-16 h-16 rounded-full bg-card shadow-elevated flex items-center justify-center z-10 transition-transform hover:scale-105 active:scale-95 disabled:opacity-70 overflow-hidden pointer-events-auto">
              <motion.img src={logo} alt="Logo" className="w-12 h-12 object-contain" animate={isSpinning ? {
            rotate: 360
