...
const cuisineColorMap: Record<string, string> = {
  "بحرية": "#1e3a5f", // Dark blue for seafood
  "بحري": "#1e3a5f",
  "يابانية": "#E84C5C", // Red
  "ياباني": "#E84C5C",
  "إيطالية": "#FFB347", // Orange
  "إيطالي": "#FFB347",
  "بيتزا": "#FFB347", // Orange (same as Italian)
  "حلويات": "#DDA0DD", // Purple/Pink
  "برجر": "#90EE90", // Green
  "خليجية": "#F4A460", // Sandy brown
  "خليجي": "#F4A460",
  "مكسيكية": "#FF6B6B", // Coral red
  "مكسيكي": "#FF6B6B",
  "هندية": "#9370DB", // Purple
  "هندي": "#9370DB",
  "صينية": "#FFD700", // Gold
  "صيني": "#FFD700",
  "تركية": "#E57373", // Light red
  "تركي": "#E57373",
  "لبنانية": "#81C784", // Light green
  "لبناني": "#81C784",
  "قهوة": "#8B4513", // Coffee brown
  "معجنات": "#D2691E", // Chocolate/pastry color
  "دايت": "#32CD32", // Lime green for healthy
  "وجبات سريعة": "#FF4500", // Orange-red for fast food
  "أخرى": "#A0A0A0", // Gray for other
  "منوع": "#87CEEB", // Sky blue for mixed
  "شاورما": "#CD853F", // Peru brown for shawarma
  "مشاوي": "#B22222", // Firebrick for grills
...
const SpinWheel = ({ onResult, selectedCategory = "الكل", cuisines }: SpinWheelProps) => {
