import { Home, Heart, User, FileText, Shield } from "lucide-react";
...
const BottomNav = () => {
  ...
  /* Sidebar logic no longer needed here */

  const navItems = [
    { icon: <Heart className="w-6 h-6" />, label: t("ذوقي", "My Taste"), path: "/my-list" },
